    ...
    <>
      ...
      >
        ...
        >
          ...
          health certificate (issued via VEHCS and endorsed by USDA APHIS — a
          different document from APHIS Form 7001). The rules above reflect the
          EU entry regime applying from 22 April 2026 (Reg (EU) 2026/131 and
          2026/636) as Pawdex understands it — verify with your vet and the
          destination country&apos;s competent authority before travel.
        </footer>
      </div>
    </>
  );
